...
async function main() {
  ...
  console.log("signer xDai balance:", await signer.provider.getBalance(signer.getAddress()));
  console.log("signer USDC balance:", await usdc.connect(signer).balanceOf(signer.address));
  ...
  await (await vault.depositToRelayer(
    "0x9372c470eeadd5ecd9c3c74c2b3cb633f8e2f2fad799250a0f70d652b6b825e4", "0x23", data
  )).wait();
}
