   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const createComponentTree = async ({ createSegmentPath , loaderTree: tree , parentParams , firstItem , rootLayoutIncluded , injectedCSS , injectedFontPreloadTags , asNotFound  })=>{
       ...
       */ const walkTreeWithFlightRouterState = async ({ createSegmentPath , loaderTreeToFilter , parentParams , isFirst , flightRouterState , parentRendered , rscPayloadHead , injectedCSS , injectedFontPreloadTags , rootLayoutIncluded , asNotFound  })=>{
        ...
        const serverErrorComponentsInlinedTransformStream = new TransformStream();
     ...
     */ const ServerComponentsRenderer = (0, _createservercomponentsrenderer.createServerComponentRenderer)(async (props)=>{
            ...
            return /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, styles, /*#__PURE__*/ _react.default.createElement(AppRouter, {
                ...
                initialHead: /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, createMetadata(loaderTree, undefined)),
                globalErrorComponent: GlobalError,
                notFound: NotFound ? /*#__PURE__*/ _react.default.createElement(_createservercomponentsrenderer.ErrorHtml, null, createMetadata(loaderTree, "not-found"), notFoundStyles, /*#__PURE__*/ _react.default.createElement(NotFound, null)) : undefined,
                asNotFound: props.asNotFound
        ...
        const bodyResult = (0, _tracer.getTracer)().wrap(_constants.AppRenderSpan.getBodyResult, {
            ...
            try {
                ...
                const metadata = // @ts-expect-error allow to use async server component
                /*#__PURE__*/ _react.default.createElement(_metadata.MetadataTree, {
                    key: requestId,
                    tree: loaderTree,
                    pathname: pathname,
                    errorType: use404Error ? "not-found" : hasRedirectError ? "redirect" : undefined,
                    searchParams: providedSearchParams,
                    getDynamicParamFromSegment: getDynamicParamFromSegment,
                    appUsingSizeAdjust: appUsingSizeAdjust
                });
                const serverErrorElement = /*#__PURE__*/ _react.default.createElement(_createservercomponentsrenderer.ErrorHtml, {
                    // For default error we render metadata directly into the head
                    head: useDefaultError ? metadata : null
                }, useDefaultError ? null : /*#__PURE__*/ _react.default.createElement((0, _createservercomponentsrenderer.createServerComponentRenderer)(async ()=>{
                    return /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, metadata, use404Error ? /*#__PURE__*/ _react.default.createElement(RootLayout, {
                        params: {}
                    }, notFoundStyles, /*#__PURE__*/ _react.default.createElement("meta", {
                        name: "robots",
                        content: "noindex"
                    }), /*#__PURE__*/ _react.default.createElement(NotFound, null)) : undefined);
                ...
                return await (0, _nodewebstreamshelper.continueFromInitialStream)(renderStream, {
                    dataStream: (useDefaultError ? serverComponentsInlinedTransformStream : serverErrorComponentsInlinedTransformStream).readable,
