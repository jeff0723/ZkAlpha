...
export declare const ACTION_NOT_FOUND = "not-found";
...
export declare const errorOverlayReducer: React.Reducer<Readonly<OverlayState>, Readonly<BuildOkAction | BuildErrorAction | BeforeFastRefreshAction | FastRefreshAction | NotFoundAction | UnhandledErrorAction | UnhandledRejectionAction | VersionInfoAction>>;
export {};
